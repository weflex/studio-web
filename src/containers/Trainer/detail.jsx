...
class PTScheduleInjected extends React.Component {
  static propTypes = {
  ...
  onCancel() {
    ...
    UIFramework.Modal.confirm({
      title: intl.formatMessage({id: 'studio_web_trainer_detail_private_class_modal_cancel_title'}),
      content: intl.formatMessage({id: 'studio_web_trainer_detail_private_class_modal_cancel_content'}),
      onOk: async () => {
    ...
    return (
      <Row className='schedule'>
        <div className='card-header'>
          <h3><FormattedMessage id="studio_web_trainer_detail_private_class_schedule"/></h3>
          <ul className='actions'>
            {
              schedule
                ? <li>
                    <Button size='small' onClick={this.onCancel.bind(this)}>
                      <FormattedMessage id="studio_web_trainer_detail_private_class_btn_cancel"/>
                    </Button>
                  </li>
                : ""
            }
            <li>
              <Button size='small' onClick={() => {mixpanel.track( "教练详情：私教排期" );this.setState({showPTSchedule: true})}}>
                <FormattedMessage id="studio_web_trainer_detail_private_class_btn_edit"/>
              </Button>
            </li>
          </ul>
        </div>
        {
          ...
          ?<div>
            <div className='detail-card-row'>
              <label>
                <FormattedMessage id="studio_web_trainer_detail_private_class_schedule_time"/>
              </label>
            ...
            <div className='detail-card-row'>
              <label>
                <FormattedMessage id="studio_web_trainer_detail_private_class_course_duration"/>
              </label>
              <span>{ schedule.durationMinutes + intl.formatMessage({id: 'studio_web_duration_minute'}) }</span>
            </div>
            <RadioGroup onChange={this.onChange} value={schedule.orderMode} style={style}>
                <Radio disabled={this.state.disabled} value={"整点预约"}>
                  <FormattedMessage id="studio_web_trainer_detail_private_class_radio_option_mode_full_duration"/>
                </Radio>
                <Radio disabled={this.state.disabled} value={"半小时预约"}>
                  <FormattedMessage id="studio_web_trainer_detail_private_class_radio_option_mode_half_duration"/>
                </Radio>
            </RadioGroup>
            <div className='detail-card-row'>
              <label>
                <FormattedMessage id="studio_web_trainer_detail_private_class_associate_card"/>
              </label>
              <Select multiple
                      disabled
...
const PTSchedule = injectIntl(PTScheduleInjected, { withRef: true });
