...
class NewClassTemplate extends React.Component {
  ...
  componentDidMount() {
    const venue = this.props.actions.venueAction.getVenueById();
    const templates = this.props.actions.classTemplateAction.getClassTemplateList();
    const data = {
      venue
    };
    const members = this.props.actions.collaboratorAction.getCollaboratorList(data, ['roles']);
    ...
    let classPackages = this.props.actions.classPackageAction.getClassPackageList(data);
...
NewClassTemplate.propTypes = {
  ...
  collaboratorAction: PropTypes.object.isRequired,
  classPackageAction: PropTypes.object.isRequired,
}

NewClassTemplate.contextTypes = {
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    collaboratorAction: bindActionCreators(actions.collaboratorAction, dispatch),
    classPackageAction: bindActionCreators(actions.classPackageAction, dispatch),
  };
}

exports.NewClassTemplate = connect(null, mapDispatchToProps)(NewClassTemplate);
