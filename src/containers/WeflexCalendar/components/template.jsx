  ...
  render() {
    ...
    return (
      <li className="resource-calendar-template">
        ...
        <div>{template.duration}<FormattedMessage id="studio_web_duration_minute"/></div>
        <div>
        ...
        <div className="resource-calendar-template-hint">
          ...
          <div className="hint-text"><FormattedMessage id="studio_web_calendar_template_drag_hint_text"/></div>
        </div>
        <ClassCard
        ...
        />
        <UIFramework.Modal
          title={<FormattedMessage id="studio_web_calendar_template_add_course" />}
          footer=""
