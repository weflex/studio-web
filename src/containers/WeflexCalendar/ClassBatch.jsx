...
class ClassBatch extends React.Component {
  ...
  constructor(props) {
    ...
    this.cache = {
      ...
      columns: [
        {
          title: props.intl.formatMessage({id: 'studio_web_calendar_class_batch_column_time'}),
          dataIndex: 'Time',
          key: 'Time',
          width: '25%',
        }, {
          title: props.intl.formatMessage({id: 'studio_web_calendar_class_batch_column_course_name'}),
          dataIndex: 'CourseName',
          key: 'CourseName',
          width: '30%',
        }, {
          title: props.intl.formatMessage({id: 'studio_web_calendar_class_batch_column_trainer_name'}),
          dataIndex: 'TrainerName',
          key: 'TrainerName',
          width: '30%',
        }, {
          title: props.intl.formatMessage({id: 'studio_web_calendar_class_batch_column_operation'}),
          dataIndex: 'Operation',
          key: 'Operation',
          width: '15%',
        }
  ...
  renderCourseTemplates(courseTemplates) {
    ...
    return (
      <Select
        ...
        showSearch
        placeholder={intl.formatMessage({id: 'studio_web_calendar_class_batch_select_course_template'})}
  ...
  renderSchedule() {
    ...
    return [1, 2, 3, 4, 5, 6, 0].map(i => {
      ...
      return <button key={i}
                     className={className}
                     onClick={e => { this.setState({ scheduleIndex: i }) }}>
  ...
  render() {
    ...
    return (
      <UIFramework className='course-schedule'>
        <UIFramework.Row name={intl.formatMessage({id: 'studio_web_calendar_class_batch_create_a_template'})}>
            ...
            footer={() =>
              <div>
                ...
                <Button size="small"
                  ...
                  <FormattedMessage id="studio_web_calendar_class_batch_btn_add"/>
                </Button>
              </div>
            }
          />
        </UIFramework.Row>
        <UIFramework.Row name={intl.formatMessage({id: 'studio_web_calendar_class_batch_copy_time'})}
                         hint={intl.formatMessage({id: 'studio_web_calendar_class_batch_copy_time_hint'})}>
          <DatePicker
            className="small"
            value={weekStartsAt}
        ...
        <UIFramework.Button
          ...
          disabled={false}
        >
          <FormattedMessage id="studio_web_calendar_class_batch_copy"/>
        </UIFramework.Button>
      </UIFramework>
    );
  }
...
export default injectIntl(ClassBatch, { withRef: true });
