  ...
  render() {
    ...
    return (
      <Locations ref={this.setRouter.bind(this)}>
        ...
        <Location path="/booking/:bookingType/:bookingId"
          handler={createViewWithBars(require('./views/booking/detail'), this)} />
        <Location path="/booking(/:bookingType)"
          handler={createViewWithBars(require('./views/booking/index'), this)} />
        <Location path="/member(/*)"
          handler={createViewWithBars(require('./views/member/index'), this)} />
        <Location path="/settings(/*)"
          handler={createViewWithBars(require('./views/settings/index'), this)} />
          <Location path="/product(/*)"
          handler={createViewWithBars(require('./views/product/index'), this)} />
