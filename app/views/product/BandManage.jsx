...
class BandManage extends Component {
  ...
  newProductCategory() {
    return (
      <AddBand addOne={this.props.addData} style={{ float: 'right', marginRight: 10 }} buttonName={this.config.name} />
    )
  }
  render() {
    return (
